    ...
    try {
      if (type === "verify") {
        const info = await transporter.sendMail({
          from: email,
          to: destination,
          subject: "Telegram Account: Email address verification",
          html: `<!DOCTYPE html>
          <html lang="en">
          <head>
          <meta charset="UTF-8">
          ...
          <body>
              <div class="container">
              <h2>Welcome to the Telegram account registration: Please confirm!</h2>
              <p>You have registered a Telegram account with ${destination}. Please click link to continue verification account.</p>
              ...
              <p>If you have any other problems, or need additional support, please don't hesitate to contact us by email at support@Telegrams.com</p>
              
              <p>See you out on the Telegram!</p>
              
              <p>Copyright © 2021 Telegram , All rights reserved</p
              </div>
          </body>
          </html>
          `
        ...
        const info = await transporter.sendMail({
          from: email,
          to: destination,
          subject: "Telegram: Password Reset",
          html: `<!DOCTYPE html>
          <html lang="en">
          <head>
          <meta charset="UTF-8">
          ...
          <body>
              ...
              <a href="${link}/reset-password/${destination}/${token}">Reset Password</a>
              ...
              <p>If you have any other problems, or need additional support, please don't hesitate to contact us by email at support@Telegram.com</p>
