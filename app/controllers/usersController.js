...
exports.findAll = (req, res) => {
  ...
  usersModel
    .getAllUsers(page, perPage, keyword, sortBy, order, id)
...
exports.update = async (req, res) => {
  ...
  const data = {
    ...
    fullName: fullName === undefined ? initialResult[0].fullName : fullName,
    bio: bio === undefined ? initialResult[0].bio : bio
  };
