...
exports.getAllUsers = (queryPage, queryPerPage, keyword, sortBy, order, id) => {
  return new Promise((resolve, reject) => {
    connection.query(
      `SELECT COUNT(*) AS totalData FROM users WHERE  fullName LIKE ? AND NOT id=${id}`,
      ...
      (err, result) => {
        ...
        connection.query(
          `SELECT * FROM users WHERE  fullName LIKE ? AND NOT id=${id} ORDER BY ${sortBy} ${order} LIMIT ?, ?`,
